...
namespace B21_Ex02_TicTacToeGame
{
    public class TicTacToeGame
    {
        ...
        public bool IsComputerPlaying ////PROPERTY IS COMPUTER PLAYING
        {
            get
            {
        ...
        private void countSignsInMainAndSecondaryDiagonal(ref short countMain, ref short countSec, char mainSign, char secSign)
        {
            for (short i = 0, j = (short)(Board.BoardSize - 1); i < Board.BoardSize && j >= 0; i++, j--)
            {
                if (Board[i, i] == mainSign)
                {
                    countMain++;
                }

                if (Board[i, j] == secSign)
                {
                    countSec++;
                }
            }
        ...
        public void CreateListOfEmptyCells()
        {
            for (short i = 0; i < Board.BoardSize; i++)
            {
                for (short j = 0; j < Board.BoardSize; j++)
                {
                    ...
                    {
                        ListOfFreeCellsInBoard.Add(new Board.Point((short)(i + 1), (short)(j + 1)));
                    }
                }
            }
        }
        ...
        public void UpdateListOfEmptyCells(short i_Row, short i_Col)
        {
            ...
            ListOfFreeCellsInBoard.Remove(point);
        }
        ...
        public void CheckBestMove(out short o_Row, out short o_Col)
        {
            ...
            o_Row = (short)(move[0] + 1);
            o_Col = (short)(move[1] + 1);
        }
